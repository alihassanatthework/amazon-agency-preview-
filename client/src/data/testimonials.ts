...
export const testimonials: Testimonial[] = [
  { author: 'Bob Lifsey', company: 'Power Steering Resources', slug: null, featured: true, service: 'account-setup',
    quote: 'Amazon FBA Gross Revenue has increased 40%+. Successful Brand Registry.' },
  { author: 'Robert Ferreira', company: 'Seller Investigators', slug: null, featured: true, service: 'advertising-marketing',
  ...
  { author: 'Emily Saunders', company: 'Raise Them Well', slug: 'raise-them-well', featured: true, service: 'account-health',
  ...
  { author: 'Lori Hayes', company: 'Health As It Ought To Be', slug: 'health-as-it-ought-to-be', featured: false, service: 'account-health',
  ...
  { author: 'Amin Shahbaz', company: 'Rebel Rebel Personal Care', slug: null, featured: false, service: 'account-health',
  ...
  { author: 'Cheston Davis', company: 'Pyro Putty', slug: 'pyro-putty', featured: false, service: 'account-health',
  ...
  { author: 'Duran Anderson', company: 'RV Bug Stop', slug: 'rv-bug-stop', featured: false, service: 'account-health',
