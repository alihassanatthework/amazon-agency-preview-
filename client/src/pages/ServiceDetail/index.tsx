      ...
      <Section surface="bone">
        <Container>
          ...
          <RevealGroup className="problem__grid problem__grid--two" stagger={80}>
            {group.problem.map((p) => (
              <article className="problem__card card" key={p}>
      ...
      <Section surface="obsidian">
        <Container>
          ...
          <RevealGroup className="cap__grid" stagger={70}>
            {group.items.map((it) => (
              <article className="cap card" key={it.name}>
      ...
      <Section surface="carbon">
        <Container>
          ...
          <RevealGroup className="cadence" stagger={80}>
            <div className="cadence__item card"><h3 className="heading-s">Weekly</h3><p className="body-s">A 30-minute call with your account manager, plus email throughout the week.</p></div>
            <div className="cadence__item card"><h3 className="heading-s">Monthly</h3><p className="body-s">Account health review, IPI check, negative seller review removal and a written summary.</p></div>
            <div className="cadence__item card"><h3 className="heading-s">Ongoing</h3><p className="body-s">Optimisation against a live plan. Most clients see meaningful movement around months four to six.</p></div>
          </RevealGroup>
        </Container>
      </Section>
        ...
        <Section surface="obsidian">
          <Container>
            ...
            <RevealGroup className="wall wall--inline" stagger={80}>
              {proof.map((t) => (
                <figure className="wall__card card" key={t.author}>
